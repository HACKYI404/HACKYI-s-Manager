...
const EVENT_TYPES = {
  ...
  MEMBER_VOICE_JOIN: 'member.voice.join',
  MEMBER_VOICE_LEAVE: 'member.voice.leave',
  MEMBER_VOICE_MOVE: 'member.voice.move',
...
const EVENT_COLORS = {
  ...
  'member.voice.join': 0x00B0F4,
  'member.voice.leave': 0x747F8D,
  'member.voice.move': 0x5865F2,
